System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f242fGlJsRGo7gOW4Urm7dF", "MainFunctional", undefined);
      ...
      _export("Main", Main = (_dec = ccclass('Main'), _dec2 = property([Sprite]), _dec3 = property([SpriteFrame]), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Label), _dec(_class = (_class2 = class Main extends Component {
        ...
        handleInitResponse(data) {
          ...
          var anyData = data;
          var reels = (_anyData$defaultReels = anyData.defaultReels) != null ? _anyData$defaultReels : anyData.reels;
          if (!reels) return;
        ...
        handlePlayResponse(data) {
          ...
          var reels = (_ref = (_anyData$reels = anyData.reels) != null ? _anyData$reels : anyData.resultReels) != null ? _ref : anyData.defaultReels;
          ...
          var win = (_anyData$totalWin2 = anyData.totalWin) != null ? _anyData$totalWin2 : 0;
          ...
          var winLines = data.winLines;

          if (winLines && winLines.length > 0) {
            var first = winLines[0];
        ...
        setButtonEnabled(enabled) {
          ...
          var s = this.playButtonNode.getComponent(Sprite);
          ...
          for (var i = 0; i < 6; i++) {
            this.scheduleOnce(() => {
              for (var cell of this.cells) {
                var r = Math.floor(Math.random() * this.symbolFrames.length);
                var f = this.symbolFrames[r];
        ...
        applyReels(reels) {
          ...
          for (var col = 0; col < 3; col++) {
            for (var row = 0; row < 3; row++) {
              ...
              var index = col * 3 + row;
              var symbolId = reels == null || (_reels$col = reels[col]) == null ? void 0 : _reels$col[row];
              var cellSprite = this.cells[index];
              if (!cellSprite) continue;
              var frame = this.symbolFrames[(symbolId != null ? symbolId : 1) - 1];
...
//# sourceMappingURL=85a20583889da24714aefe3ecf42d9e6a1f56c73.js.map