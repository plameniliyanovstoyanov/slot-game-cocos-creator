  ...
  return {
    ...
    execute: function () {
      ...
      _export("MockApi", MockApi = class MockApi {
        ...
        static play() {
          var reels = this.buildRandomReels(); // columns‑first 3x3

          var winLines = this.evaluateWins(reels); // array of { lineNumber, winAmount, winIndexes }
        ...
        static evaluateWins(reels) {
          ...
          for (var line of DEFAULT_WIN_LINES) {
            var [i0, i1, i2] = line.indexes;
            var v0 = this.valueAt(reels, i0);
            var v1 = this.valueAt(reels, i1);
            var v2 = this.valueAt(reels, i2);
